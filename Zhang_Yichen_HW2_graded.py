...
'''Question 1'''
#Stuart- Nice example of recursive code, in practice this isn't the fastest way to
#go about this problem, also there is a recursion depth limit in python that might 
#cause a problem. But for this problem a very well written solution.
...
'''Question 6'''		
#Stuart- Nice well written recursion example.
